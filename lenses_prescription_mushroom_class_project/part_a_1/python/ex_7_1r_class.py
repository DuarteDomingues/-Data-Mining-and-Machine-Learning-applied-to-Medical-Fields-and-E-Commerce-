...
class ModelOneR():
    ...
    def evaluate( self, target, targetPred):
        ...
        print("Recall score : ", recall_score(target, targetPred , average='micro'))
        print("Precision score : ",precision_score(target, targetPred , average='micro'))
        print("F1 score : ",f1_score(target, targetPred , average='micro'))
